  ...
  class DengineAzureSdkCostList < Chef::Knife
    ...
    banner "knife dengine azure sdk cost list (options)"
      ...
      def run
        ...
        promise = cost_client.usage_details.list("/subscriptions/#{Chef::Config[:knife][:azure_subscription_id]}", expand = true, filter = $filter, skiptoken = nil, top = nil, custom_headers = nil)
